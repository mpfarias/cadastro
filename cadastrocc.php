    ...
    if(count($erro) == 0) {
        ...
        if ($conn->connect_error) {
            ...
            */
            ...
            $tabela = $conn->query('SHOW TABLES LIKE \'conta\'');
            if($tabela->num_rows == 0) {
                $conn->query('CREATE table conta(id INT(11) AUTO_INCREMENT NOT NULL, saldo DECIMAL(60,2) NOT NULL, data_nome VARCHAR(255) NOT NULL, mes VARCHAR(255) NOT NULL, PRIMARY KEY (id));');
            }
            ...
            $conn->query('INSERT INTO conta('.$campos.') VALUES('.$valores.')');
            /* SE TUDO ESTIVER OK, REDIRECIONO PARA UMA PÁGINA DE SUCESSO */
            header('location: SucessoConta.php');
