    ...
    if(count($erro) == 0) {
        ...
        if ($conn->connect_error) {
            ...
            */
            ...
            $tabela = $conn->query('SHOW TABLES LIKE \'fixas\'');
            if($tabela->num_rows == 0) {
                $conn->query('CREATE table fixas(id INT(11) AUTO_INCREMENT NOT NULL, local VARCHAR(255) NOT NULL, data VARCHAR(255) NOT NULL, valor DECIMAL(60,2) NOT NULL, mes VARCHAR(10) NOT NULL, ano VARCHAR(255) NOT NULL, PRIMARY KEY (id));');
            }
            ...
            $conn->query('INSERT INTO fixas('.$campos.') VALUES('.$valores.')');
            /* SE TUDO ESTIVER OK, REDIRECIONO PARA UMA PÁGINA DE SUCESSO */
            header('location: SucessoFixas.php');
