    ...
    if(count($erro) == 0) {
        ...
        if ($conn->connect_error) {
            ...
            */
            ...
            $tabela = $conn->query('SHOW TABLES LIKE \'meses\'');
            if($tabela->num_rows == 0) {
                $conn->query('CREATE table meses(id INT(11) AUTO_INCREMENT NOT NULL, mes VARCHAR(255) NOT NULL, ano VARCHAR(255) NOT NULL, PRIMARY KEY (id));');
            }
            ...
            $conn->query('INSERT INTO meses('.$campos.') VALUES('.$valores.')');
